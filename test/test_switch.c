...
void test_switchExclusion(void)
{
	...
	EXCLUSION_STATE expected[TESTS*2] = {
		EXCLUSION_NOMATCH, EXCLUSION_NOMATCH, EXCLUSION_MATCH,
		EXCLUSION_NOMATCH, EXCLUSION_NOMATCH, EXCLUSION_MATCH,
		EXCLUSION_MATCH, EXCLUSION_NOMATCH
	};
	int index = 0;
	struct tm time[4] = {
		{
...
void test_switchContext(void)
{
	...
	SWITCH_STATE expected[TESTS*8] = {
		SWITCH_NOTNEEDED, SWITCH_NOTNEEDED, SWITCH_SUCCESS,
		SWITCH_SUCCESS, SWITCH_SUCCESS, SWITCH_NOTNEEDED,
		SWITCH_NOTNEEDED, SWITCH_SUCCESS, SWITCH_FAILURE,
		SWITCH_SUCCESS, SWITCH_FAILURE, SWITCH_NOTNEEDED,
		SWITCH_FAILURE, SWITCH_FAILURE, SWITCH_FAILURE,
		SWITCH_FAILURE, SWITCH_NOTNEEDED, SWITCH_NOTNEEDED,
		SWITCH_SUCCESS, SWITCH_SUCCESS, SWITCH_SUCCESS,
		SWITCH_NOTNEEDED, SWITCH_SUCCESS, SWITCH_SUCCESS,
		SWITCH_FAILURE, SWITCH_FAILURE, SWITCH_FAILURE,
		SWITCH_FAILURE, SWITCH_NOTNEEDED, SWITCH_FAILURE,
